...
const seed = async () => {
  try {
    ...
    // ⚽ Dữ liệu sân bóng đá
    const footballs = [
      { name: "Sân 7A", size: "7 người", location: "Khu A" },
      { name: "Sân 7B", size: "7 người", location: "Khu A" },
      { name: "Sân 7C", size: "7 người", location: "Khu A" },
      { name: "Sân 7D", size: "7 người", location: "Khu A" },
      { name: "Sân 5-1", size: "5 người", location: "Khu B" },
      { name: "Sân 5-2", size: "5 người", location: "Khu B" },
    ];

    // 🏀 Dữ liệu sân bóng rổ
    const basketballs = [
      { name: "Sân A1", location: "Khu C" },
      { name: "Sân A2", location: "Khu C" },
    ];

    // 🎾 Dữ liệu sân tennis
    const tennis = [
      { name: "Sân A1", location: "Khu D" },
      { name: "Sân A2", location: "Khu D" },
      { name: "Sân A3", location: "Khu D" },
      { name: "Sân A4", location: "Khu D" },
    ];
